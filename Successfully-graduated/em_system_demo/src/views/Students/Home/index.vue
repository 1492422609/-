    ...
    <el-col :span="8" style="margin-top: 10px">
      <el-card shadow="hover" style="margin-left: 20px; width: 540px">
        <div class="user">
          ...
          <div class="userinfo">
            <h4 class="student">学生信息</h4>
          </div>
          <i></i>
        </div>
        <div class="login-info">
          <p class="name">姓名：{{stu_name}}</p>
          <p>学校：<span>{{stu_school}}</span></p>
          <p>学院：<span>{{stu_campus}}</span></p>
          <p>班级：<span>{{stu_class}}</span></p>
          <p>专业：<span>{{stu_pro}}</span></p>
        </div>
      </el-card>
      <el-card
        shadow="hover"
...
export default {
  ...
  methods: {
    ...
    getData(){
      ...
      this.stu_name = res.stu_name
      this.stu_school=res.stu_school
      this.stu_campus = res.stu_campus
      this.stu_class = res.stu_class
      this.stu_pro = res.stu_pro
